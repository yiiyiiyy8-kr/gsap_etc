...
//처음 화면에 들어오지 전 기본 스티키 이미지를 1번으로 세팅
...
//track 전체 너비에서 화면에 이미 보이는 너비를 뺴면 이동 거리만 남음
function  totalWidth(){
...
const caseImages = article.querySelectorAll('.case_images')
...
document.querySelectorAll('.magnet_zone').forEach((zone)=>{
  ...
  zone.addEventListener('moseleave',()=>{
